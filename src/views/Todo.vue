...
export default {
    ...
    methods:{
        async agregarTodo(){
            await this.axios.post('https://backend-semanatec.herokuapp.com/todo',this.newTodo).then((response)=>{
        ...
        async finalizarTodo(id){
            await this.axios('https://backend-semanatec.herokuapp.com/todo/complete/'+id).then((response)=>{
                console.log(response)
                this.cargarTodos();
            })
        },
        cargarTodos(){
            this.axios('https://backend-semanatec.herokuapp.com/todo/list').then((response)=>{
